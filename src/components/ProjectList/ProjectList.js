    ...
    return (
        <div data-aos="fade-up" className="projects">
            ...
            <Link to="/projects/market-stats" className="project-link" >
                <div data-aos="fade-up" className="project-card project-card--left">
            ...
            <Link to="/projects/translyric" className="project-link" >
                <div data-aos="fade-up" className="project-card project-card--right">
            ...
            <div data-aos="fade-up" className="project-card--noImage">
